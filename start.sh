...
npx -y prisma generate --silent 2>/dev/null || echo "⚠️ Client déjà généré"
echo "   → Application des migrations..."
npx -y prisma migrate deploy --schema=./prisma/schema.prisma 2>/dev/null || echo "⚠️ Migrations déjà appliquées"
cd "$DIR"
